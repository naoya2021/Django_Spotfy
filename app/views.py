...
class IndexView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request,'app/templates/app/list.html',{
                'list_data':list_data,
                'keyword':keyword
            })
...
class DetailView(View):
    def get(self,request,*args,**kwargs):
        ...
        return render(request,'app/templates/app/detail.html',{
...
def signup(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            user = form.save()
            login(request, user)
            render(request,'app/templates/app/index.html')
    else:
        form = UserCreationForm()
    return render(request, 'app/templates/app/signup.html', {'form': form})
